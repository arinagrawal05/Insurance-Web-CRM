...
class FdDashboardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final statsProvider = Provider.of<FDStatsProvider>(context, listen: true);
    final dashProvider = Provider.of<DashProvider>(context, listen: true);

    return Scaffold(
      appBar: customAppbar("FD Dashboard", context),
                          ...
                          Expanded(
                            ...
                            child: Row(
                              children: [
                                ...
                                statsBox("${0} Companies",
                                    Ionicons.build_outline, context),
                                // statsBox(0.toString() + " Plans",
